...
%changelog
* Tue Mar 03 2015 Jason Montleon <jmontleo@redhat.com> 0.2.9-1
- update bastion to 0.2.9 (jmontleo@redhat.com)

* Mon Mar 02 2015 Jason Montleon <jmontleo@redhat.com> 0.2.8-1
- update to 0.2.8 (jmontleo@redhat.com)

* Mon Mar 02 2015 Jason Montleon <jmontleo@redhat.com> 0.2.7-1
- update bastion to 0.2.7 (jmontleo@redhat.com)

* Wed Feb 18 2015 Jason Montleon <jmontleo@redhat.com> 0.2.6-1
- update bastion to 0.2.6 (jmontleo@redhat.com)

* Fri Feb 13 2015 Jason Montleon <jmontleo@redhat.com> 0.2.5-3
- add missing file to package (jmontleo@redhat.com)

* Fri Feb 13 2015 Jason Montleon <jmontleo@redhat.com> 0.2.5-2
- change angular-rails-templates dependency version (jmontleo@redhat.com)

* Fri Feb 13 2015 Jason Montleon <jmontleo@redhat.com> 0.2.5-1
- update rubygem-bastion to 0.2.5 (jmontleo@redhat.com)

* Tue Feb 10 2015 Jason Montleon <jmontleo@redhat.com> 0.2.2-2
- update bastion to 0.2.2 (jmontleo@redhat.com)
